                    ...
                    <ul class="plan-features">
                        <li v-for="feat in plan.features" :key="feat" class="plan-feat-row">
                            ...
                            <span class="feat-check">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 text-blue-700" viewBox="0 0 24 24"
...
/* ── Badge container (spacer for alignment) ── */
.plan-badge-container {
    height: 28px; /* Match badge height + margin */
    position: relative;
}
/* ── "Most Popular" badge ── */
.popular-badge {
